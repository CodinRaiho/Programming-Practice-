...
int  main(){
    ...
    j-=1;//-------------------------------->Understanding 1 integer = 4 bytes by (pointer decrement) 
    ...
    b-=1;//-------------------------------->Understanding 1 integer = 4 bytes by (pointer decrement) 
    ...
    d-=1;//-------------------------------->Understanding 1 integer = 4 bytes by (pointer decrement) 
